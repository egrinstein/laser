...
mix:
	@python -m data.mixing.audiocaps_wav_mixer --in_csv_dir config/datafiles/csvs/ --out_json_dir config/datafiles/ --in_wav_dir ~/data/oliveira/audiocaps/ --out_wav_dir ~/data/oliveira/audiocaps/mix
