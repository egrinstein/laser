# This file is used to mix the audiocaps dataset using its mix.csv file, as well as creating a mix.json file, which can then be loaded as an AudioTextMixDataset.
...
#
#
# A mix.json file is created by iterating over the AudioCaps .csv file and creating a dictionary for each row.
# The output json file looks like this:
# {
#     "data": [
#      {
#       "wav_mixture": "path/to/[audiocap_id].wav",
#       "caption_mixture": [caption]
#      },
#      ... 
#     ]
# }
